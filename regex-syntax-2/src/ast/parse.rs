...
impl<'s, P: Borrow<Parser>> ParserI<'s, P> {
    ...
    fn parse_escape(&self) -> Result<Primitive> {
        ...
        match c {
            ...
            c => Err(self.error(span, ast::ErrorKind::EscapeUnrecognized)),
        }
    }
...
# This is comment 4.";
    ...
    fn parse_counted_repetition() {
        ...
        assert_eq!(
            parser_ignore_space(r"a{5,9} ?").parse(),
            Ok(Ast::Repetition(ast::Repetition {
                span: span(0..8),
                op: ast::RepetitionOp {
                    span: span(1..8),
    ...
    fn parse_set_class() {
        fn set(
            ...
            ast::Class::Bracketed(ast::ClassBracketed {
                span: span,
                negated: negated,
                kind: kind,
            })
        ...
        assert_eq!(
            parser_ignore_space("[a ").parse().unwrap_err(),
            TestError {
                span: span(0..1),
                kind: ast::ErrorKind::ClassUnclosed,
            });
    ...
    fn parse_set_class_open() {
        ...
        assert_eq!(
            parser_ignore_space("[    ").parse_set_class_open().unwrap_err(),
            TestError {
                span: span(0..5),
                kind: ast::ErrorKind::ClassUnclosed,
            });
