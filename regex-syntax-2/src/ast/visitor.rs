...
/// A trait for visiting an abstract syntax tree in depth first order.
///
...
/// is proportional to end user input.
///
/// Typical usage of this trait involves providing an implementation and then
/// running it using the [`visit`](fn.visit.html) function.
///
/// TODO(burntsushi): Talk about the hir::Visitor trait here.
pub trait Visitor {
...
/// analysis over an `Ast` without using a stack size proportional to the size
